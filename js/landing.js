...
// Sekret: 5 kliknięć w "DL" w stopce w ciągu 1,5 s.
...
document.querySelectorAll('[data-close-pin]').forEach((b) =>
  b.addEventListener('click', () => $('pinModal').classList.remove('show')));
